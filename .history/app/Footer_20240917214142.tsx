...
const Footer = () => {
  return (
    <div className="mx-10 flex flex-col gap-10 mt-40">
        <Separator />
        ...
        <div className="flex flex-col md:flex-row items-center">
            <div className="w-2/3 px-10"><Image src="/assets/ecpaklogo.png" width={200} height={60} alt="" /></div>
        ...
        <div className="mx-10 mb-10">
            <p className="text-xl font-medium text-slate-800">©2024 Euroconsult Private Limited. <br></br><span className="text-base font-normal">All Rights Reserved</span></p>
        </div>
    </div>
  )
}
