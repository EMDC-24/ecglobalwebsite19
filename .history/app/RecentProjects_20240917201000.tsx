...
const RecentProjects = () => {
  return (
    <div className="flex flex-col mx-20">
        ...
        <div className="bg-gray-100 inline-flex w-auto border-gray-200 border-[1px] rounded-full px-2 py-1 text-sm text-slate-800 font-light">Hydropower & Energy</div>
