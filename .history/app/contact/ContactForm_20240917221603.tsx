...
export function ContactForm() {
  return (
    <Card className="w-full border-0 flex flex-row items-center justify-center">
      <CardHeader>
        ...
        <form>
          <div className="flex flex-col w-full items-start gap-4">
            ...
            <div className="flex flex-col gap-1.5 w-full pr-24 justify-between items-start mx-6 mb-5">
