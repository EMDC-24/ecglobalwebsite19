...
const RecentProjects = () => {
  return (
    <div className="flex flex-col mx-20">
        ...
        <div className="w-1/2 flex flex-col gap-3 border-[1px] border-gray-200 rounded-2xl p-10">
        <div><div className="bg-gray-100 w-auto inline-flex border-gray-200 border-[1px] rounded-full px-2 py-1 text-sm text-blue-700 font-light h-[320px]">Hydropower & Energy</div></div>
