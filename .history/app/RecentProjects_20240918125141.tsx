...
const RecentProjects = () => {
  return (
    <div className="flex flex-col mx-20">
        ...
        <p className="font-light text-slate-800 text-justify">Euroconsult was proud to be a key player in the Karachi Water and Sewerage Services Improvement Project (KWSSIP), specifically leading the implementation of SOP-2. Our work focused on strategic infrastructure enhancements, capacity building, and creating an enabling environment for improved water and sanitation services in Karachi. Through our expertise, we contributed to the development of sustainable water supply systems and operational reforms, in alignment with KWSSIP's long-term objectives.</p>
        <a href="#" >Learn More</a>
        </div>
        <div className="w-1/2 flex flex-col gap-3 border-[1px] border-gray-200 rounded-2xl p-10">
        ...
        <div><div className="bg-gray-100 inline-flex w-auto border-gray-200 border-[1px] rounded-full px-2 py-1 text-sm text-blue-700 font-light">Hydropower & Energy</div></div>
        <h3 className="font-light text-slate-800 text-2xl">Sales & Business Development</h3>
        <p className="font-light text-slate-800">Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae harum recusandae iusto rem sapiente qui voluptatem enim rerum, obcaecati neque asperiores possimus tempora, numquam consequuntur voluptatum? Earum porro eaque magnam!</p>
        <a href="#" >Learn More</a>
        </div>
