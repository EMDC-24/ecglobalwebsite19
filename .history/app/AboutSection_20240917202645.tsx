  ...
  return (
    <div className="px-10 flex flex-col items-center justify-center">
        <div className="my-10 gap-5 flex flex-col">
            <h3 className="text-[40px] tracking-tight leading-snug font-medium text-slate-800 px-72 text-center">Comprehensive Training & Consulting Solutions Tailored to Your Needs</h3>
