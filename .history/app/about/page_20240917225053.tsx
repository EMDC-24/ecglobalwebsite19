...
const page = () => {
  return (
    <div>
        ...
        <p className="font-light text-justify text-slate-800">Euroconsult Pakistan is an emerging global, state-of-the-art service provider organization actively engaged in water resources and energy, agriculture, infrastructure, environ- ment, oil and gas, mass transit, light rail, motorways, highways, institutional capacity building, financial management, rural and urban development, and management. With client satisfaction as our core business approach, we fulfill project or program needs from
