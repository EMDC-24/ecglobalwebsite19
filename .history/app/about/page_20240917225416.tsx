...
const page = () => {
  return (
    <div>
        ...
        <div className="w-1/3 border-[1px] border-gray-200 rounded-2xl p-5">
        <p>At Euroconsult Pakistan, we are a premier consulting and services firm dedicated to propelling our clients towards enduring success. We leverage a team of exceptional professionals who possess unparalleled skills and access to cutting-edge data. This enables us to provide our clients with the insights and guidance they need to make informed, strategic decisions that drive sustainable growth.</p>
        </div>
