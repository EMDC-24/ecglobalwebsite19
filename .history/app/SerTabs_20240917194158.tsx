...
const tabs = [
  ...
  { id: 'tab7', label: 'Management Consulting', content: 'Content for Button 3' },
  { id: 'tab8', label: 'Roads & Bridges', content: 'Content for Button 3' },
  { id: 'tab9', label: 'Public Health Engineering', content: 'Content for Button 3' },
  { id: 'tab10', label: 'Solid Waste Management', content: 'Content for Button 3' },
