...
const Hero = () => {
  ...
  return (
    <div>
        ...
        <Button variant="outline" className="px-5 py-6 text-lg font-light  hover:bg-gray-200" onClick={getInTouchClick}>Contact Us<FaAngleRight className="mr-2 ml-2 h-4 w-4" /></Button>
