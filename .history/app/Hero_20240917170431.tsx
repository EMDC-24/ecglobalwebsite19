...
const Hero = () => {
  return (
    <div>
        ...
        <h1 className="text-5xl text-gray-800 mt-3 font-light font-sans">Empowering Excellence through Engineering & Consulting</h1>
        ...
        <a href="#" >
        <Button className="px-5 py-5 text-lg font-light  hover:bg-blue-600">Get Started  <FaAngleRight className="mr-2 ml-2 h-4 w-4" /></Button>
        </a>
        <a href="#" >
        <Button variant="outline" className="px-5 py-5 text-lg font-light  hover:bg-gray-200">Contact Us<FaAngleRight className="mr-2 ml-2 h-4 w-4" /></Button>
        </a>
        </div>
        </div>
