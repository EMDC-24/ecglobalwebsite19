  ...
  return (
    <div className="flex flex-col px-20 my-20">
      <div className="flex flex-col gap-5 w-1/4 my-10">
        ...
        <p className="font-light text-slate-800">Experiential and transformational sales and leadership training</p>
      </div>
        ...
        <div className="w-[60%] pl-20">
          {activeTabContent && (
            <div className="flex flex-col gap-4">
              ...
              ></div>
              <h2 className="text-3xl ">{activeTabContent.heading}</h2>
              <p dangerouslySetInnerHTML={{ __html: activeTabContent.paragraph }} className="text-slate-800 font-light"/>
              <a
                href={activeTabContent.buttonRoute}
                className="mt-3"
              >
                <Button variant="outline" className="px-5 py-6 text-lg font-light">Learn More  <FaAngleRight className="mr-2 ml-2 h-4 w-4" /></Button>
