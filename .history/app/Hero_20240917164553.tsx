...
const Hero = () => {
  return (
    <div>
        ...
        <a href="#" >
        <Button className="px-5 py-5 text-lg font-light rounded-full hover:bg-blue-600">Get Started<FaAngleRight className="mr-2 h-4 w-4" /></Button>
        </a>
        <a href="#" >
        <Button variant="outline">Contact Us<FaAngleRight className="mr-2 h-4 w-4" /></Button>
        </a>
        </div>
        </div>
