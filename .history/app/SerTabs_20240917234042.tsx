    ...
    return (
      <div className="flex flex-col px-20 my-20">
        <div className="flex flex-col gap-5 w-1/4 my-10">
          ...
          <p className="font-light text-slate-800">Leverage our comprehensive suite of services, from cutting-edge technology to construction, consulting and efficient engineering.</p>
        </div>
