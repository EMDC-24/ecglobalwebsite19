    ...
    <div className="px-10 flex flex-col items-center justify-center">
        ...
        <div className="flex flex-row gap-10 px-24 mt-10">
            <div className="w-1/2 flex gap-5 flex-col">
                ...
                <p className="tracking-tight font-light"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Explicabo nisi dolorem voluptas velit obcaecati laborum placeat aliquid ipsum voluptate, repudiandae a, deserunt dignissimos exercitationem, neque sit. Placeat ullam quo ipsum!</p>
            </div>
