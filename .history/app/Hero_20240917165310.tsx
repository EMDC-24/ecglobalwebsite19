...
const Hero = () => {
  return (
    <div>
        <div className="bg-white px-0 flex flex-row py-20 gap-10">
        <div className="md:w-1/2 pl-10 flex flex-col items-start justify-normal">
        ...
        <div className="md:w-1/2 h-auto rounded-2xl bg-cover bg-center" style={{ backgroundImage: `url('/assets/heroimage.jpg')` }}> </div>
        </div>
    </div>
  )
}
