...
const Hero = () => {
  return (
    <div>
        <div className="bg-white px-10 flex flex-row py-20">
        ...
        <a href="#" >
        <Button variant="outline" className="px-5 py-5 text-lg font-light rounded-full hover:bg-gray-200">Contact Us<FaAngleRight className="mr-2 ml-2 h-4 w-4" /></Button>
        </a>
        </div>
        </div>
        <div className="md:w-1/2 flex flex-col gap-3">
        <div className="w-full h-2/3 rounded-2xl bg-cover bg-center" style={{ backgroundImage: `url('/assets/heroimage.jpg')` }}> </div>
        <div className="w-full h-1/3 rounded-2xl bg-cover bg-center" style={{ backgroundImage: `url('/assets/hero2.jpg')` }}> </div>
        </div>
        </div>
    </div>
  )
