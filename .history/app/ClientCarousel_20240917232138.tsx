...
const ClientCarousel = () => {
  ...
  const logos = [
    <Image src="/assets/adblogo.png" alt="" width={70} key="br" {...logoSize} />,
    <Image src="/assets/uniceflogo.png" alt="" width={70} key="br" {...logoSize} />,
    ...
    <Image src="/assets/usaidlogo.png" alt="" width={120} key="br" {...logoSize} />,
    <Image src="/assets/undplogo.png" alt="" width={70} key="br" {...logoSize} />,
    ...
    <Image src="/assets/wblogo.png" alt="" width={70} key="br" {...logoSize} />,
  ];
