...
const PraiseSection = () => {
  return (
    ...
    <div className="w-1/2 flex flex-col gap-3">
        ...
        <div className="w-auto mt-3"><Button className="px-5 py-6 text-lg font-light  hover:bg-blue-700">Get in Touch  <FaAngleRight className="mr-2 ml-2 h-4 w-4" /></Button></div>
    </div>
