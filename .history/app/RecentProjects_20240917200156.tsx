...
const RecentProjects = () => {
  return (
    <div className="flex flex-col mx-20">
        ...
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae harum recusandae iusto rem sapiente qui voluptatem enim rerum, obcaecati neque asperiores possimus tempora, numquam consequuntur voluptatum? Earum porro eaque magnam!</p>
        </div>    
        </div>
    </div>
  )
