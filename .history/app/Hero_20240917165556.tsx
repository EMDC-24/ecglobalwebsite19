...
const Hero = () => {
  return (
    <div>
        ...
        <div className="w-full h-3/5 rounded-2xl bg-cover bg-center" style={{ backgroundImage: `url('/assets/heroimage.jpg')` }}> </div>
        <div className="w-full h-2/5 rounded-2xl bg-cover bg-center" style={{ backgroundImage: `url('/assets/hero2.jpg')` }}> </div>
        </div>
        </div>
    </div>
  )
