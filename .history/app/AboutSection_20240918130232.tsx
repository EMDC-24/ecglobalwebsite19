  ...
  return (
    <div className="px-10 flex flex-col items-center justify-center">
        ...
        <div className="flex flex-row gap-10 px-24 mt-10">
            ...
            <Button variant="outline" className="px-5 py-6 text-lg font-light  hover:bg-gray-200" onClick={aboutClick}>Learn More<FaAngleRight className="mr-2 ml-2 h-4 w-4" /></Button>
            ...
            <Button  className="px-5 py-6 text-lg font-light bg-black  hover:bg-blue-600" onClick={getInTouchClick}>Get in Touch<FaAngleRight className="mr-2 ml-2 h-4 w-4" /></Button>
